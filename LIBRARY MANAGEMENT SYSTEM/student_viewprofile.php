	  ...
	  <div class="container">
	    ...
	    <center style="text-align: center; color:#FFFFFF";>
	      ...
	      <?php
	        ...
	        $q = mysqli_query($connect, "SELECT * FROM student_reg where StudentID='$_SESSION[studentID]';");
	        $row = mysqli_fetch_assoc($q);
	        echo "<div style='text-align: center'><img src='images/AdminPic.png' style='width:100px;height:100px;'></div>";
	        echo "<h3>Welcome</h3>";
