...
<html>
	...
	<body>
	  ...
	  <div class="container" style="text-align: center;" >
	    ...
	    <h3 style="color: whte;"><?php echo "   Welcome-".$_SESSION['admin_logged']; ?> </h3>
	    <?php
	      $sql = "SELECT `AdminName`, `Email`, `Mobile`, `Password`, `Address` FROM `admin_login` where `AdminID`='$_SESSION[admin_logged]'";
	  ...
	  <?php
	    if(isset($_POST['submit']))
	    {
	      ...
	      $sql1 = "UPDATE `admin_login` SET `AdminName`='$name', `Email`='$email', `Mobile`='$mobile', `Password`='$password', `Address`='$address' WHERE `AdminID`='$_SESSION[admin_logged]' ";
