	...
	<body style="text=#FFFFFF">
		<div class="wrapper">
			<header>
				...
				<nav>
					<ul>
						<li><a href="index.php">HOME</a></li>	<!--directing this to real index-->
	    ...
	    <div class="container">
	      ...
	      <form  action="" method="post">
	        <label>Student ID</label> <input type="text" name="StudentID" value="" class="form-control" required=""><br>
	      ...
	      <?php
	        ...
	        {
	          $sql=mysqli_query($connect, "UPDATE `student_reg` SET `Password` = '$_POST[password]' WHERE `student_reg`.`StudentID` = '$_POST[StudentID]' ;");
	          if($sql){
